...
\begin{figure}[H]
    \centering
    \subfloat[This was the output from the program at room temperature.]{\includegraphics[width=0.7\textwidth]{Figures/Part2_before.png} \label{fig:before}}
    \hfill
    \subfloat[This was the output from the program when submerged in liquid nitrogen.]{\includegraphics[width=0.7\textwidth]{Figures/Part2_after.png} \label{fig:after}}
