...
\begin{figure}[H]
    \centering
    \subfloat[This was the output from the program at room temperature.]{\includegraphics[width=0.39\textwidth]{Figures/Part2_before2.png} \label{fig:before}}
    \hfill
    \subfloat[This was the output from the program when submerged in liquid nitrogen.]{\includegraphics[width=0.39\textwidth]{Figures/Part2_after2.png} \label{fig:after}}
