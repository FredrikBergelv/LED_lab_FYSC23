...
\begin{figure}[H]
    \centering
<<<<<<< HEAD
    \subfloat[This was the output from the program at room temperature.]{\includegraphics[width=0.49\textwidth]{Figures/Part2_before2.png} \label{fig:before}}
    \hfill
    \subfloat[This was the output from the program when submerged in liquid nitrogen.]{\includegraphics[width=0.49\textwidth]{Figures/Part2_after2.png} \label{fig:after}}
=======
    \subfloat[This was the output from the program at room temperature.]{\includegraphics[width=0.6\textwidth]{Figures/Part2_before.png} \label{fig:before}}
    \hfill
    \subfloat[This was the output from the program when submerged in liquid nitrogen.]{\includegraphics[width=0.6\textwidth]{Figures/Part2_after.png} \label{fig:after}}
>>>>>>> df5e9fde69925e901e00af7a1247625d82392834
